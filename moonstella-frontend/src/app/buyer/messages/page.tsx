...
export default function BuyerMessagesPage() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem('ms_buyer_chats')
    let currentChats: Chat[] = stored ? JSON.parse(stored) : []

    if (currentChats.some((c) => c.id === 'elena_kc' || c.id === 'julian_thorne')) {
      currentChats = []
      localStorage.removeItem('ms_buyer_chats')
    }
    ...
    if (chatWithParam) {
      ...
      if (existing) {
        ...
        const newChat: Chat = {
          id: newId,
          name: chatWithParam,
          specialty: 'Jewelry Designer & Maker',
          avatar: '/suggested_botanical.png',
          online: true,
          messages: []
        }
        currentChats = [newChat, ...currentChats]
        localStorage.setItem('ms_buyer_chats', JSON.stringify(currentChats))
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    localStorage.setItem('ms_buyer_chats', JSON.stringify(updatedChats))
    setChatInput('')
    ...
    setTimeout(() => {
      const replyMsg: Message = {
        sender: 'artisan',
        text: "Thank you for reaching out. I have received your message and will review it as soon as I am back from my jewelry workbench.",
      ...
      setChats(finalChats)
      localStorage.setItem('ms_buyer_chats', JSON.stringify(finalChats))
    }, 1500)
  }
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-gray-500 truncate mt-1">
                    {lastMsg ? lastMsg.text : 'Start your jewelry inquiry...'}
                  </p>
                </div>
              </div>
            )
            ...
            {activeChat.messages.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center text-center p-8 select-none my-auto">
                ...
                <p className="text-[10px] text-gray-400 mt-1 max-w-[240px] leading-relaxed">
                  Start your conversation by typing a message below to coordinate your commission brief.
                </p>
              </div>
            ) : (
