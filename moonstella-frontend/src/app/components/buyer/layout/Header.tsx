    ...
    <header className="w-full bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.01)] px-6 flex items-center justify-between sticky top-0 z-40 h-14 transition-all duration-300">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="text-gray-700 hover:text-[#3D0C1F] transition-all cursor-pointer p-1.5 rounded hover:bg-gray-50 flex items-center justify-center relative z-50 border-none bg-transparent"
          title="Menu"
        >
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="text-gray-600 hover:text-[#3D0C1F] relative p-1.5 rounded-full hover:bg-gray-50 transition-all cursor-pointer border-none bg-transparent"
          >
          ...
          {notificationsOpen && (
            <div className="absolute right-0 mt-2.5 w-72 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50 py-1.5 animate-fade-in text-xs">
