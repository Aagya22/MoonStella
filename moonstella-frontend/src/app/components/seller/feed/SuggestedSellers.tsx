          ...
          {suggestedSellers.length === 0 ? (
            <div className="py-8 text-center flex flex-col items-center justify-center gap-3 bg-[#FAF8F5]/50 border border-dashed border-gray-100 rounded-xl">
              ...
              <p className="text-[9px] text-gray-400 px-4 leading-normal select-none">
                All master gold and silversmiths are currently busy crafting bespoke pieces.
              </p>
            </div>
          ) : (
              ...
              {suggestedSellers.map((seller) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 select-none">
                    <h4 className="text-xs font-bold text-gray-855 truncate">{seller.name}</h4>
                    <p className="text-[9px] text-gray-400 font-semibold tracking-wider uppercase mt-0.5">Master Artisan</p>
                  </div>
                </div>
              ))}
            </div>
